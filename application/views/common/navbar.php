	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo site_url('home/index'); ?>" >RE</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					<li id="homeActive"><a href="<?php echo site_url('home/index'); ?>">HOME</a></li>
					<li id="aboutUsActive"><a href="<?php echo site_url('home/aboutUs'); ?>">ABOUT US</a></li>
					<li id="ridingRulesActive"><a href="<?php echo site_url('home/ridingRules'); ?>">RIDING-RULES</a></li>
					<li id="aboutUsActive"><a href="<?php echo site_url('home/aboutUs'); ?>">gallery</a></li>
